          ...
          <div class="one-third">
            ...
            ${
              results.programs.length > 0
                ? '<ul class="link-list min-list">'
                : `<p>No programs match that search. <a href=${universityData.root_url}>View all programs</a></p>`
            }
            ${results.programs
              .map(
                (item) =>
            ...
            <h2 class="search-overlay__section-title">Professors</h2>
              ${
                results.professors.length > 0
                  ...
                  : `<p>No professor match that search.</p>`
              }
              ${results.professors
                .map(
                  (item) =>
          ...
          <div class="one-third">
            <h2 class="search-overlay__section-title">Campuses</h2>
              ${
                results.campuses.length > 0
                  ? '<ul class="link-list min-list">'
                  : `<p>No campuses match that search. <a href=${universityData.root_url}>View all programs</a></p>`
              }
              ${results.campuses
                .map(
                  (item) =>
            ...
            ${
              results.events.length > 0
                ? ""
                : `<p>No events match that search. <a href=${universityData.root_url}>View all Events</a></p>`
            }
            ${results.events
              .map(
                (item) =>
